  ...
  <div id="wrapper">
    <nav class="navbar is-dark">
      <div class="navbar-brand">
        <router-link to="/" class="navbar-item"><strong>Book shop</strong></router-link>
      ...
      <div class="navbar-end">
          <router-link to="/novels" class="navbar-item">Романы</router-link>
          <router-link to="/stories" class="navbar-item">Рассказы</router-link>
